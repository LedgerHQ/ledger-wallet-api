# High level API to the Ledger Wallet Bitcoin Chrome application

This is the high level JS API to the [Ledger Wallet Bitcoin Chrome](https://github.com/LedgerHQ/ledger-wallet-chrome) application. With this API, you can communicate directly with the Chrome app and use embedded features such as requesting information about accounts or, or send a Bitcoin transaction.
