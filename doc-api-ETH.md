# High level API to the Ledger Wallet Ethereum Chrome application

This is the high level JS API to the [Ledger Wallet Ethereum Chrome](https://github.com/LedgerHQ/ledger-wallet-ethereum-chrome) application. With this API, you can communicate directly with the Chrome app and use embedded features such as requesting information about accounts or, or send a transaction.
...
https://www.ledgerwallet.com/api/demo-eth.html

## Usage

First, you need to insert the `ledger-eth.js` file in your page:

```html
<head>
  <script src="ledger-eth.js"></script>
</head>
```
